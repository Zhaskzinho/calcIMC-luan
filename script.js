...
btncalcular.addEventListener("click", function (e) {
    ...
    if (sexo.value == 'masculino') {
        if (imc < 18.5) {
            imagemresultado.innerHTML = `<img src='images/magro.png' alt='Magreza' >`
        } else if (imc >= 18.5 && imc <= 24.9) {
            imagemresultado.innerHTML = `<img src = 'images/peso-ideal.png' alt='Normal'>`

        } else if (imc >= 25 && imc <= 29.9) {
            imagemresultado.innerHTML = `<img src = 'images/acima do peso.png' alt='Sobrepeso'>`

        } else if (imc >= 30 && imc <= 39.9) {
            imagemresultado.innerHTML = `<img src = 'images/gordo.png' alt='Obesidade'>`
